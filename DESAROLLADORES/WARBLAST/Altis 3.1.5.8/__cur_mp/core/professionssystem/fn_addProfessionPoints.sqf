...
[format["<t color='#40FF00'>%1 increased by</t> <t color='#2E2EFE'>%2 XP!</t>",[_id] call life_fnc_varToStr,_points]] spawn life_fnc_showNotification;

//Save the variable and send to the database!
missionNamespace setVariable[_id,_current];
[9] call SOCK_fnc_updatePartial;
if(!isNil 'CL_Debug') then {systemChat format["Added: %1 New Score: %2",_points,_current];};