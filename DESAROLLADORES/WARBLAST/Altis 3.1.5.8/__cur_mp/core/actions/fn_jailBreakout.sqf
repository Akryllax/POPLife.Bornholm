...
[[0,"Somebody is attempting to break prisoners out of the jail!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP; //Give everyone a systemchat
...
if(_ok) then {
	...
	[[0,"The jailbreak ended with people being broken out. They are now on the run."],"life_fnc_broadcast",true,false] spawn life_fnc_MP; //Give everyone a systemchat
	...
	[[0,"The jailbreak ended with no people being broken out."],"life_fnc_broadcast",true,false] spawn life_fnc_MP; //Give everyone a systemchat
};