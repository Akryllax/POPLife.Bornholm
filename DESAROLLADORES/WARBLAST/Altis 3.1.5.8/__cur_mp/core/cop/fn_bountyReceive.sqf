...
if(playerSide == civilian) then {_val = ceil(_val / 2); _total = ceil(_total / 2)}; //HALF THE BOUNTY PRICE FOR THEM.
if(playerSide == west) exitWith {}; //Cops don't get bounties anymore...
