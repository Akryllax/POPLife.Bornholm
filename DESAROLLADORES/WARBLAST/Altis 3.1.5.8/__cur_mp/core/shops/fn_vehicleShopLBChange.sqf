...
ctrlShow [2330,true];
(getControl(2300,2303)) ctrlSetStructuredText parseText format["<t size='1.1'><img image='%9' size='1.5'/> %10</t><br/>Permament: %12<br/>Class: %11<br/>Purchase Price: <t color='#8cff9b'>£%1</t><br/>Rental Price: <t color='#8cff9b'>£%2</t><br/>Max Speed: %3 km/h<br/>Horse Power: %4<br/>Passenger Seats: %5<br/>Trunk Capacity: %6<br/>Fuel Capacity: %7<br/>Armor Rating: %8",
[_basePrice] call life_fnc_numberText,
[round(_basePrice * 0.5)] call life_fnc_numberText, //CL - Vehicle rental, reduce price by a third. 12/08/2014
