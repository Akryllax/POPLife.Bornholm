...
if(life_popeur < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - life_popeur] call life_fnc_numberText];};
...
life_popeur = life_popeur - _basePrice;
