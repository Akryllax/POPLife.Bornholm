...
if(_action) then {
	if(ALUK_bankedwonga < (_houseCfg select 0)) exitWith {hint localize "STR_House_NotEnough"};
	[100] call life_fnc_addXP;
	...
	ALUK_bankedwonga = ALUK_bankedwonga - (_houseCfg select 0);
