...
//Phone Booths
life_actions pushBack (player addAction["<t color='#CCCC00'>Smart Phonebooth</t>",{createDialog "Life_my_smartphone";},"",0,FALSE,FALSE,"",' vehicle player == player && {[] call life_fnc_nearPhone} ']);