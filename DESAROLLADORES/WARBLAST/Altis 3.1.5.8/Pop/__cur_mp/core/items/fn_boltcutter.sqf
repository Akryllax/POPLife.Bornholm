...
_fail = false;
_house = false;
if((nearestObject [[7912.02,16148.6,0.396378],"Land_i_Barracks_V2_F"]) == _building) then {
...
if(_house) then {[[getPlayerUID player,profileName,"459"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;};