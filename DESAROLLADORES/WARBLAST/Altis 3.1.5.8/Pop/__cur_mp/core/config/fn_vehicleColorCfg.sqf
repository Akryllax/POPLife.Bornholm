...
switch (_vehicle) do
{
	...
	case "C_Hatchback_01_sport_F":
	{
		...
		[
			...
			["textures\police\land\hatchback.paa","cop"],
			["textures\nhs\land\hatchback_sport.paa","med"],
			["textures\police\land\rtuhatchback.paa","cop"]			
		];
	};
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["#(ai,64,64,1)Fresnel(0.3,3)","cop"], //was fed
			["textures\police\land\offroad.paa","cop"],
			["#(argb,8,8,3)color(0.6,0.3,0.01,1)","civ"],
			["textures\nhs\land\offroad.paa","med"],
			["textures\police\land\rtuoffroad.paa","cop"],
	...
	case "C_Hatchback_01_F":
	{
		...
		[
			...
			["textures\police\land\hatchback.paa","cop"],
			["textures\nhs\land\hatchback_normal.paa","med"]
		];
	};
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\police\land\suv.paa","cop"],
			["\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_03_co.paa","civ"],
			["\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_04_co.paa","civ"],
			["textures\nhs\land\suv.paa","med"],
			["textures\civilian\taxi\taxi.paa","taxi"],
			["textures\police\land\rtusuv.paa","cop"],
	...
	case "C_Van_01_box_F":
	{
		...
		[
			...
			["textures\nhs\land\amfront.paa","med","textures\nhs\land\amback.paa"],
	...
	case "B_MRAP_01_F":
	{
		_ret = 
		[
			["textures\police\land\hunterfront.paa","cop","textures\police\land\hunterback.paa"],
			["textures\police\land\hunterfront.paa","cop","textures\police\land\hunterbackarv.paa"]
		];
	};
	...
	case "I_Truck_02_covered_F":
	{
		...
		[
			...
			["textures\police\land\transportfront.paa","cop","textures\police\land\transportrear.paa"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["textures\police\air\i99.paa","cop"],
