...
switch(_shop) do
{
			...
			case (call life_fnc_isAR):
			{
				["Altis ARV Armoury",
					[
						...
						["srifle_LRR_SOS_F","M320",0],
						["srifle_LRR_camo_SOS_F","M320 Camo",0],
						["srifle_GM6_SOS_F",nil,0],
						["7Rnd_408_Mag","M320x7 Rnd",0],
						["5Rnd_127x108_Mag","GM6/AS50x5 Rnd",0],
			...
			default
			{
				["PRNA Arms Store",
					[
						...
						["srifle_LRR_SOS_F","M320",0],["srifle_LRR_camo_SOS_F","M320 Camo",0],
						["srifle_GM6_F","GM6",0],["srifle_GM6_camo_F","GM6Camo",0],
						...
						["200Rnd_65x39_cased_Box_Tracer",nil,0],["10Rnd_762x51_Mag",nil,0],["20Rnd_762x51_Mag",nil,0],
						...
						["7Rnd_408_Mag","M320x7 Rnd",0],["5Rnd_127x108_Mag","GM6x5 Rnd",0],
			...
			default
			{
				["Blackmarket Weapon Shop",
					[
						...
						//7.62mm Wilco V1 June2014
						["srifle_DMR_01_F",nil,160000],["srifle_EBR_F",nil,230000],
	...
	case "donator":
	{
		switch(true) do
		{
			case (__GETC__(life_samaritan) == 0): {"You are not a donator! Visit AltisLife.co.uk"};
			case (__GETC__(life_samaritan) > 0):
			{
				["The VIP Club",
					[
						//Handguns
						...
						["10Rnd_762x51_Mag",nil,800],["20Rnd_762x51_Mag",nil,1600],
						["150Rnd_762x51_Box",nil,2500],["6Rnd_RedSignal_F",nil,5000],
