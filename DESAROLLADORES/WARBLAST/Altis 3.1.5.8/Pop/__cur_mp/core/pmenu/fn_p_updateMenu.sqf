...
_skills = _dialog displayCtrl 2016;
_struct = "";
lbClear _inv;
lbClear _near;
lbClear _near_i;
...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='icons\bank.paa'/> <t size='0.8px'>£%1</t><br/><img size='1.2' image='icons\money.paa'/> <t size='0.8'>£%2</t>",[ALUK_bankedwonga] call life_fnc_numberText,[ALUK_wonga] call life_fnc_numberText];
...
_skills ctrlSetStructuredText parseText format["
<t size='0.8px'>
Unspent Points: %1
<br/>
%3%2/100 towards your next point!
<br/>
Only %4 XP to go!
</t>
",(life_skills select 1),(life_skills select 2),"",100-(life_skills select 2)];