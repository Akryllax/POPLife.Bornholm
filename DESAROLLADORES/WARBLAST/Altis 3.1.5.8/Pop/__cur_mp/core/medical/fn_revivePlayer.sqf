...
ALUK_bankedwonga = ALUK_bankedwonga + 7500;
life_action_inUse = false;
_target setVariable["Revive",TRUE,TRUE];
[[profileName],"life_fnc_revived",_target,FALSE] spawn life_fnc_MP;
titleText[format[localize "STR_Medic_RevivePayReceive",_targetName,7500],"PLAIN"];
["reviving",20] call life_fnc_addProfessionPoints;
sleep 0.6;
player reveal _target;
[30] call life_fnc_addXP;