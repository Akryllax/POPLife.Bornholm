...
if(ALUK_bankedwonga < 750) exitWith {hint "You do not have £750 in your bank to pay for this!";};
...
ALUK_bankedwonga = ALUK_bankedwonga - 750;
if(!local _vehicle) then {
	[[_vehicle,1],"life_fnc_setFuel",_vehicle,false] spawn life_fnc_MP;
} else {
	_vehicle setFuel 1;
};
cutText[format["Your %1 has been refueled. Thanks for your buisness!",_vehicleName],"PLAIN DOWN"];