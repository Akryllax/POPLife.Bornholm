...
if(ALUK_bankedwonga < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-ALUK_bankedwonga)] call life_fnc_numberText];};
