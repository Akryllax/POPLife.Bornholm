...
[
	...
	'==== Weapons ====','==== Magazines ====','==== Bags ====','==== Vehicles ====','==== Loadouts ====','==== AltisLife Money ====',
	'Teleport Target To Me','Teleport To','Copy Gear','Revive','Heal','Repair','Move In My Vehicle','Move In Target Vehicle',
	'Spawn UAV','Spawn Epoch_Cloak_F','Spawn Sapper_F','Spawn GreatWhite_F','Eject','Eject Crew','Kill','Zeus',	'Force Disconnect','Kick',
	'Ban','Box-ESP','Map-Icons','PlotPole Marker','Vehicle Marker','Construction Marker','LockBox Marker','DeadPlayer Marker',
...
/*  Use Notification check*/ _UNC = false;	/* true or false */
/*  Use CfgGlasses check  */ _UCG = false;	/* true or false */
...
/*  Use EH_Fired check   */ _EHF = false;	/* true or false */
/*  Remove Action Plrs   */ _OAP = false;	/* true or false */
...
/*  Use Item Check   */ _UFI = true;	/* true or false */
_ForbiddenItems =
[
...
/*  Use Ammo Check   */ _UFA = true;	/* true or false */
_ForbiddenAmmo =
[
...
_SupportBox1Content =
[
	'KitPlotPole',['KitWoodFloor',5],'EnergyPackLg'
];

_SupportBox2Content =
[
	'KitPlotPole',['KitFoundation',5],'EnergyPackLg'
];

_SupportBox3Content =
[
	'KitPlotPole',['KitStudWall',5],'EnergyPackLg'
];
/* ********************************************************************************* */
/* ********************************************************************************* */
/* ********************************************************************************* */
