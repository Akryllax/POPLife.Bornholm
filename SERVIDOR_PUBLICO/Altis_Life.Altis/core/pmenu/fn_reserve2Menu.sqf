...
if(_curTarget isKindOf "House_F" && playerSide == west) exitWith {
	if((nearestObject [getMarkerPos "Reserva2","Land_Dome_Big_F"]) == _curTarget OR (nearestObject [getMarkerPos "Reserva2","Land_Research_house_V1_F"]) == _curTarget) then {
		
		_Btn1 ctrlSetText localize "Abrir reserva";
		_Btn1 buttonSetAction "[cursorTarget] call life_fnc_doorAnimate; closeDialog 0;";
		_Btn1 ctrlShow true;
		
		_Btn2 ctrlSetText localize "Reparar reserva";
