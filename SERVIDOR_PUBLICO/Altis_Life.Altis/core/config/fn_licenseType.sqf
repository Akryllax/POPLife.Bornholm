...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "plane": {_var = "license_civ_plane"}; //Pilot/air license cost
			...
			case "tortuga": {_var = "license_civ_tortuga"};
			case "pelar": {_var = "license_civ_pelar"};
			case "cement": {_var = "license_civ_cement"};
			case "mair": {_var = "license_med_air"};
			case "home": {_var = "license_civ_home"};
			case "zumos": {_var = "license_civ_zumos"};
			case "fusion": {_var = "license_civ_fusion"};
			case "licenciauranio": {_var = "license_civ_licenciauranio"};
			case "licenciabomba": {_var = "license_civ_licenciabomba"};
			case "bountyh": {_var = "license_civ_bountyh"};
			case "limpiarp": {_var = "license_civ_limpiarpescado"};
			case "enlatarp": {_var = "license_civ_enlatarpescado"};
			case "enlatara": {_var = "license_civ_enlataratun"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_tortuga": {_var = "tortuga"};
			case "license_civ_pelar": {_var = "pelar"};
			case "license_civ_cement": {_var = "cement"};
			case "license_med_air": {_var = "mair"};
			case "license_civ_home": {_var = "home"};
			case "license_civ_zumos": {_var = "zumos"};
			case "license_civ_fusion": {_var = "fusion"};
			case "license_civ_licenciauranio": {_var = "licenciauranio"};
			case "license_civ_licenciabomba": {_var = "licenciabomba"};
			case "license_civ_bountyh": {_var = "bountyh"};
			case "license_civ_limpiarpescado": {_var = "limpiarp"};
			case "license_civ_enlatarpescado": {_var = "enlatarp"};
			case "license_civ_enlataratun": {_var = "enlatara"};
			default {_var = ""};
		};
	};
};
