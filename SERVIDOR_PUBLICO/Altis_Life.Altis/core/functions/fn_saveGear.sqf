...
if(playerSide == west || playerSide == civilian && {(call life_save_civ)} || playerSide == east) then {
...

{
    ...
    ["life_inv_salemap", life_inv_salemap],
    ["life_inv_ornatep", life_inv_ornatep],
    ["life_inv_mackerelp", life_inv_mackerelp],
    ["life_inv_mulletp", life_inv_mulletp],
    ["life_inv_tunap", life_inv_tunap],
    ["life_inv_surimi", life_inv_surimi],
    ["life_inv_lataatun", life_inv_lataatun],	
	...
	["life_inv_biofruta", life_inv_biofruta],
	["life_inv_zipties",life_inv_zipties],
	["life_inv_uenriquecido", life_inv_uenriquecido],
	["life_inv_bombanuclear", life_inv_bombanuclear],
	["life_inv_jerinCostipado", life_inv_jerinCostipado],
	["life_inv_jerinEbola", life_inv_jerinEbola],
	["life_inv_jerinCeguera", life_inv_jerinCeguera],
	["life_inv_jerinTranquilizante", life_inv_jerinTranquilizante],
	["life_inv_jerinHipotermia", life_inv_jerinHipotermia],
	["life_inv_medicAntibiotico", life_inv_medicAntibiotico],
	["life_inv_medicAnticuerpos", life_inv_medicAnticuerpos],
	["life_inv_medicCalor", life_inv_medicCalor]	
];
...
//Akryllax: Guardamos el lanzamisiles.
