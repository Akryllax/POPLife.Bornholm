...
if(player distance (getMarkerPos "zona_segura_mer") < 60) exitWith {};
if(player distance (getMarkerPos "zona_segura_reb") < 60) exitWith {};
if(player distance (getMarkerPos "zonasegura_pirgos") < 60) exitWith {};
life_knockout = true;
