...
if(!((player distance (getMarkerPos "police_hq_1") < 60) OR  (player distance (getMarkerPos "policia_hq_2") < 60) OR (player distance (getMarkerPos "policia_hq_3") < 60) OR (player distance (getMarkerPos "policia_hq_4") < 60) OR (player distance (getMarkerPos "policia_hq_5") < 60) OR (player distance (getMarkerPos "policia_hq_6") < 60) OR (player distance (getMarkerPos "policia_hq_6") < 60))) then 
{
