...
switch (life_veh_shop select 0) do
{
	...
	case "civ_noob_truck":	{_ret = license_civ_truck;};
	case "reb_car": {_ret = license_civ_rebel;};
	case "bhws": {_ret = license_civ_bountyh;};
	...
	case "mer_car_shop": {_ret = true;};
	case "mer_air_shop": {_ret = true;};
	case "civ_plane": {_ret = license_civ_plane;};
	case "donor_car": {_ret = license_civ_driver};
	case "donor_air": {_ret = license_civ_air};
	case "donor_reb_car": {_ret = license_civ_rebel};
	case "donor_reb_heli": {_ret = license_civ_rebel};
	case "donor_plane": {_ret = license_civ_plane};
