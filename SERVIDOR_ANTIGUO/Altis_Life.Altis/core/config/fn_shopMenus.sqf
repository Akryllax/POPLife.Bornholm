...
ctrlSetText[601,format["Dinero: %1€",[life_cash] call life_fnc_numberText]];
...
switch (_shop) do
{
	...
	case "divecop":
	{
		ctrlSetText[2505,"Tienda buceo de la policia"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
	...
	case "divemer":
	{
		ctrlSetText[2505,"Tienda buceo de los mercenarios"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
