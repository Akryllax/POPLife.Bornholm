...
_clothes = switch (life_clothing_store) do
{
	...
	case "divecop": {[_selection] call life_fnc_clothing_dive_cop;};
	case "divemer": {[_selection] call life_fnc_clothing_dive_mer;};
	case "kart": {[_selection] call life_fnc_clothing_kart;};
	case "mer": {[_selection] call life_fnc_clothing_mer;};
	case "bhc": {[_selection] call life_fnc_clothing_bhc;};
};
