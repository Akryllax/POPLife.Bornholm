...
if((_this select 3) in ["divecop"] && playerSide != west) exitWith { hint localize "STR_Shop_NotaCop"; closeDialog 0;};
if((_this select 3) in ["divemer"] && playerSide != east) exitWith { hint localize "STR_Shop_NotaMer"; closeDialog 0;};
