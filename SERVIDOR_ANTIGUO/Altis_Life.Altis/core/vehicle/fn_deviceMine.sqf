...
_resourceZones = ["u234_1","u235_1","u238_1","apple_1","apple_2","pear_1","pear_2","peaches_1","peaches_2","heroin_1","cocaine_1","weed_1","heroin_1_1","cocaine_1_1","weed_1_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["heroin_1","heroin_1_1"]): {"heroinu"};
	case (_zone in ["cocaine_1","cocaine_1_1"]): {"cocaine"};
	case (_zone in ["weed_1","weed_1_1"]): {"cannabis"};
...
//	case (_zone in ["oil_1","oil_2"]): {"oilu"};
	...
	case (_zone in ["u234_1"]): {"u234"};
	case (_zone in ["u235_1"]): {"u235"};
	case (_zone in ["u238_1"]): {"u238"};
	default {""};
};
