...
_rip = true;
_kassa = 100000 + round(random 300000);
...
if(_cops < 3) exitWith{[[_vault,-1],"disableSerialization;",false,false] spawn life_fnc_MP; hint "No hay suficientes policias!";};
disableSerialization;
5 cutRsc ["life_progress","PLAIN"];
_ui = uiNameSpace getVariable "life_progress";
_progress = _ui displayCtrl 38201;
_pgText = _ui displayCtrl 38202;
_pgText ctrlSetText format["Robo en progreso, permanece cerca (20m) (1%1)...","%"];
...
_Pos = position player; // by ehno: get player pos
				                ...
				                "Marker200" setMarkerText "!ATENCION! Robo en curso !ATENCION!";
				                "Marker200" setMarkerType "mil_warning";			
if(_cP >= 1) exitWith {};
if(_robber distance _shop > 20) exitWith { };
if!(alive _robber) exitWith {};
};
if!(alive _robber) exitWith { _rip = false; };
if(_robber distance _shop > 20) exitWith { deleteMarker "Marker200"; _shop switchMove ""; hint "Tienes que estar a menos de 20m para robar! - El robo ha fracasado."; 5 cutText ["","PLAIN"]; _rip = false; };
5 cutText ["","PLAIN"];
...
sleep 1800;
_action = _shop addAction["Robo",life_fnc_robOilStation];	
_shop switchMove "";