...
if(_curTarget getVariable["reserve_dome",false] && playerSide == west) exitWith {
			
	_Btn1 ctrlSetText localize "STR_Akr_OpenVault";
	_Btn1 buttonSetAction "[cursorTarget] call life_fnc_doorAnimate; closeDialog 0;";
	_Btn1 ctrlShow true;
	
	_Btn2 ctrlSetText localize "STR_Akr_RepaiVault";
	_Btn2 buttonSetAction "[cursorTarget] call AKR_fnc_repairDoors; closeDialog 0;";
	_Btn2 ctrlShow true;
