...
switch (true) do
{
	...
	case (player distance (getMarkerPos "oil_1") < 40) : {_mine = "oilu"; _val = 4;};
	case (player distance (getMarkerPos "oil_2") < 40) : {_mine = "oilu"; _val = 4;};
	case (player distance (getMarkerPos "rock_1") < 50): {_mine = "rock"; _val = 2;};
	case (player distance (getMarkerPos "u234_1") < 30): {_mine = "u234"; _val = 2;};
	case (player distance (getMarkerPos "u235_1") < 30): {_mine = "u235"; _val = 2;};
	case (player distance (getMarkerPos "u238_1") < 30): {_mine = "u238"; _val = 2;};
	default {_mine = "";};
};
//Mine check
