...
//dar enfermeades
[true,"jerinHipotermia",round(1 + random(2))] call life_fnc_handleInv;
[true,"jerinCostipado",round(1 + random(2))] call life_fnc_handleInv;
[true,"jerinEbola",1] call life_fnc_handleInv;
[true,"jerinCeguera",round(1 +random(2))] call life_fnc_handleInv;
[true,"jerinTranquilizante",round(1 +random(2))] call life_fnc_handleInv;

//pagar al jugador
[]spawn{sleep 2;hint format["Has robado el laboratorio",_this select 0];sleep 3;hint ""};
