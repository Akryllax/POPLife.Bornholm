...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='textures\icons\bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='textures\icons\money.paa'/> <t size='0.8'>$%2</t>",[pop_banco] call life_fnc_numberText,[pop_dinero] call life_fnc_numberText];
