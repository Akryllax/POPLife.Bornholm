...
_side = switch(playerSide) do {case west:{"cop"}; case civilian:{"civ"}; case independent:{"med"}; case east: {"merc"};};
...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='textures\icons\bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='textures\icons\money.paa'/> <t size='0.8'>$%2</t>",[life_atmcash] call life_fnc_numberText,[life_popeur] call life_fnc_numberText];
