...
//pagar al jugador
pop_dinero = pop_dinero +500000+150000;
//hint
...
//this addAction["Transportar Droga para el Narco 500000$ - Ganancia: 150000$",QUICK_fnc_TransportarDrogaMar];
//////////////////////////////////////////////////////////
...
//puede pagar?¿
 if(pop_dinero - _precio < 0) exitWith { hint "No tienes suficiente dinero";[] spawn { sleep 5;hint "";} };
