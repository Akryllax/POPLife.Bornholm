...
if(pop_dinero < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - pop_dinero] call life_fnc_numberText];};
...
pop_dinero = pop_dinero - _basePrice;
