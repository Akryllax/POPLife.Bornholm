...
switch (_side) do {
	...
	case civilian: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', civ_licenses='%4', civ_gear='%6', arrested='%7', civPosition='%8', alive='%9', civ_prof='%10' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear,[_this select 7] call DB_fnc_bool,parseText format["""%1""", _civPosition],[_alive, 0] call DB_fnc_bool,_prof];};
	...
	case east: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', merc_gear='%4', merc_licenses='%5' WHERE playerid='%6'",_name,_cash,_bank,_gear,_licenses,_uid];};
};
