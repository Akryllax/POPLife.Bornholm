...
-- ----------------------------
-- Procedure structure for setPlayerDead
-- ----------------------------
DROP PROCEDURE IF EXISTS `setPlayerDead`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setPlayerDead`()
BEGIN
