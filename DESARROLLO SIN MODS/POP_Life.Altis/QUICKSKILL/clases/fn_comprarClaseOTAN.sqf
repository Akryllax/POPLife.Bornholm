//this addAction["Equipar Clase OTAN",QUICK_fnc_comprarClaseOTAN]; this setObjectTexture[0,"textures\CARTELES\equipos.jpg"]
...
_unit setObjectTextureGlobal [0, "textures\TRAJES\otan.jpg"];
