...
weatherTemplates = [
        ["Clear",[0,1],[0.30,0,0,1,1]],                      //0
        ["Overcast",[0,1,2],[0.50,0,0,2,2]],                   //1
        ["Light Rain",[1,2],[0.60,0.3,0.05,3,3]],          //2
        ["Medium Rain",[2,3,4],[0.70,0.5,0.05,4,4]],           //3
        ["Rainstorm",[2,1],[0.80,0.9,0.1,5,5]],                  //4
        ["Light Fog",[0,2,5],[0.4,0,[0.2,0.01,10],0,0]],     //5
        ["Medium Fog",[5,6,7],[0.4,0,[0.4,0.005,20],0,0]],     //6
        ["Dense Fog",[6],[0.5,0,[0.4,0.0025,30],0,0]]          //7
	];
