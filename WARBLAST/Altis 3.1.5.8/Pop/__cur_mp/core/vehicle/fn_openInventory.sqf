...
if(isNull _vehicle OR !(_vehicle isKindOf "Car" OR _vehicle isKindOf "Cargo_base_F" OR _vehicle isKindOf "Air" OR _vehicle isKindOf "Ship" OR _vehicle isKindOf "House_F")) exitWith {}; //Either a null or invalid vehicle type.
...
if(typeName (_vehicle getVariable["Trunk",-1]) == typeName -1) exitWith {};
