...
[] spawn {
	...
	_role1names = ["Welcome to", "AltisLife.co.uk"];
	_role2 = "Chat with us on Teamspeak!";
	_role2names = ["ts.altislife.co.uk"];
	_role3 = "We are number one!";
	_role3names = ["Number #1 ranked Altis Life","Server and Community in the UK", "AltisLife.co.uk"];
	_role4 = "Twitter";
	...
	_role6names = ["Wilco","Ciaran","CSI Fuel","DSGT Robert","DI God", "Crazyone","CSI Fisher"];
	_role7 = "Support us";
	_role7names = ["Please support us by donating on AltisLife.co.uk"];
