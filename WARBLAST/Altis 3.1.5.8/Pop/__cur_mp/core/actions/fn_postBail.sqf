...
if(ALUK_bankedwonga < life_bail_amount) exitWith {hint format[localize "STR_NOTF_Bail_NotEnough",life_bail_amount];};

ALUK_bankedwonga = ALUK_bankedwonga - life_bail_amount;
life_bail_paid = true;
