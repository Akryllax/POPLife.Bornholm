...
["Setting up client","Your client is currently loading ALUK. Please wait."] call _doMsg;
...
["Loading Config Files","Your client is currently loading the ALUK config files. Please wait."] call _doMsg;
...
["Finished Receiving Data","Data received, Welcome to ALUK!"] call _doMsg;
0 cutFadeOut 9999999;
...
[] spawn {
	while {true} do {
		...
		hint "Data synced to the ALUK Hive, next sync in 10-20 minutes.";
	};	
};
