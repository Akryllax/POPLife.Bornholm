...
player createDiaryRecord ["servinf", //Container
	[
		...
		"
		Our forum address is http://www.altislife.co.uk<br /><br />
		Our Teamspeak 3 server can be found at ts.altislife.co.uk<br /><br />
...
player createDiaryRecord ["servrule", //Container
	[
		...
		"
		Read the rules at AltisLife.co.uk in the Announcements\Information section!
		"
	]
];