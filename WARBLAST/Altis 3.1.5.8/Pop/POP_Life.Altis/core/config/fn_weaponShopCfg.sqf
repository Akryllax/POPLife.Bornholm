			...
			case (__GETC__(life_coplevel) == 1): {
				["Tienda general de policia",
				 [
					 ...
					 ["SMG_02_F", nil, 5000* Desc],
                     ["30Rnd_9x21_Mag", nil, 75* Desc],
                     ["arifle_SDAR_F", nil, 5000* Desc],
                     ["20Rnd_556x45_UW_mag", nil, 75* Desc],
                     ["optic_Aco_smg", nil, 50* Desc],
			...
			case (__GETC__(life_coplevel) == 2): {
				["Tienda locales",
				 [
                     ...
                     ["arifle_SDAR_F", nil, 5000* Desc],
                     ["20Rnd_556x45_UW_mag", nil, 75* Desc],
                     ["arifle_mas_g36c", nil, 10000* Desc],
                     ["30Rnd_mas_556x45_Stanag", nil, 100* Desc],
                     ["optic_Aco_smg", nil, 50* Desc],
                     ["optic_MRCO", nil, 100* Desc],
			...
			case (__GETC__(life_coplevel) == 3): {
				["Tienda nacionales",
				 [
                     ...
                     ["arifle_mas_g36c", nil, 10000* Desc],
                     ["30Rnd_mas_556x45_Stanag", nil, 100* Desc],
                     ["arifle_MX_Black_F", nil, 15000* Desc],
                     ["30Rnd_65x39_caseless_mag", nil, 150* Desc],
                     ["arifle_mas_mp5", nil, 20000* Desc],
                     ["30Rnd_mas_9x21_Stanag", nil, 150* Desc],
                     ["RH_M16A2", nil, 20000* Desc],
                     ["RH_30Rnd_556x45_M855A1", nil, 150* Desc],
                     ["optic_MRCO", nil, 100* Desc],
                     ["optic_Hamr", nil, 100* Desc],
                     ["acc_flashlight", nil, 100* Desc],
                     ["acc_mas_pointer_IR_b", nil, 100* Desc],
			...
			case (__GETC__(life_coplevel) == 5): {
				["Tienda nacionales",
				 [
					 ...
					 ["arifle_SDAR_F", nil, 5000* Desc],
                     ["20Rnd_556x45_UW_mag", nil, 75* Desc],
                     ["arifle_MXM_Black_F", nil, 25000* Desc],
                     ["30Rnd_65x39_caseless_mag", nil, 150* Desc],
                     ["arifle_mas_mp5", nil, 20000* Desc],
                     ["30Rnd_mas_9x21_Stanag", nil, 150* Desc],
                     ["RH_M16A3", nil, 25000* Desc],
                     ["RH_m4", nil, 25000* Desc],
                     ["RH_30Rnd_556x45_M855A1", nil, 150* Desc],
                     ["srifle_EBR_F", nil, 50000* Desc],
                     ["20Rnd_762x51_Mag", nil, 200* Desc],
                     ["launch_RPG32_F", nil, 150000* Desc],
                     ["RPG32_HE_F", nil, 20000* Desc],
                     ["optic_MRCO", nil, 100* Desc],
                     ["optic_Hamr", nil, 100* Desc],
                     ["RH_ta01nsn", nil, 150* Desc],
                     ["optic_Arco", nil, 100* Desc],
                     ["RH_eotech553", nil, 150* Desc],
                     ["optic_mas_DMS", nil, 200* Desc],
                     ["optic_SOS", nil, 200* Desc],
                     ["acc_pointer_IR", nil, 100* Desc],
                     ["acc_flashlight", nil, 100* Desc],
                     ["acc_mas_pointer_IR_b", nil, 100* Desc],
			...
			case (__GETC__(life_coplevel) == 6): {
				["Tienda nacionales",
				 [
					 ...
					 ["arifle_SDAR_F", nil, 5000* Desc],
                     ["20Rnd_556x45_UW_mag", nil, 75* Desc],
                     ["arifle_MX_SW_Black_F", nil, 60000* Desc],
                     ["100Rnd_65x39_caseless_mag_Tracer", nil, 500* Desc],
                     ["arifle_mas_mp5", nil, 20000* Desc],
                     ["30Rnd_mas_9x21_Stanag", nil, 150* Desc],
                     ["RH_M16A4", nil, 30000* Desc],
                     ["RH_M4A1_ris_M203", nil, 30000* Desc],
                     ["RH_30Rnd_556x45_M855A1", nil, 2500* Desc],
                     ["srifle_EBR_F", nil, 50000* Desc],
                     ["20Rnd_762x51_Mag", nil, 200* Desc],
                     ["srifle_mas_hk417", nil, 60000* Desc],
                     ["20Rnd_mas_762x51_Stanag", nil, 500* Desc],
                     ["launch_RPG32_F", nil, 150000* Desc],
                     ["RPG32_HE_F", nil, 20000* Desc],
                     ["optic_MRCO", nil, 100* Desc],
                     ["optic_Hamr", nil, 100* Desc],
                     ["RH_ta01nsn", nil, 150* Desc],
                     ["optic_Arco", nil, 100* Desc],
                     ["RH_eotech553", nil, 200* Desc],
                     ["RH_ta31rmr_2D", nil, 200* Desc],
                     ["optic_mas_DMS", nil, 200* Desc],
                     ["optic_SOS", nil, 200* Desc],
                     ["RH_accupoint", nil, 200* Desc],
                     ["acc_pointer_IR", nil, 50* Desc],
                     ["acc_flashlight", nil, 50* Desc],
                     ["acc_mas_pointer_IR_b", nil, 100* Desc],
                     ["RH_qdss_nt4", nil, 200* Desc],
			...
			case (__GETC__(life_coplevel) == 7): {
				["Tienda nacionales",
				 [ 
					 ...
					 ["arifle_SDAR_F", nil, 2500* Desc],
                     ["20Rnd_556x45_UW_mag", nil, 2500* Desc],
                     ["arifle_mas_mp5", nil, 2500* Desc],
                     ["30Rnd_mas_9x21_Stanag", nil, 2500* Desc],
                     ["RH_M16A6", nil, 2500* Desc],
                     ["RH_30Rnd_68x43_FMJ", nil, 2500* Desc],
                     ["RH_M4A1_ris_M203", nil, 2500* Desc],
                     ["RH_30Rnd_556x45_M855A1", nil, 150* Desc],
                     ["srifle_EBR_F", nil, 60000* Desc],
                     ["20Rnd_762x51_Mag", nil, 500* Desc],
                     ["srifle_mas_hk417", nil, 60000* Desc],
                     ["20Rnd_mas_762x51_Stanag", nil, 500* Desc],
                     ["RH_Mk11", nil, 100000* Desc],
                     ["RH_20Rnd_762x51_Mk316LR", nil, 1000* Desc],
                     ["LMG_Mk200_F", nil, 100000* Desc],
                     ["200Rnd_65x39_cased_Box", nil, 1000* Desc],
                     ["LMG_mas_mk48_F", nil, 120000* Desc],
                     ["100Rnd_mas_762x51_Stanag", nil, 1000* Desc],
                     ["srifle_LRR_F", nil, 150000* Desc],
                     ["7Rnd_408_Mag", nil, 1500* Desc],
                     ["srifle_GM6_F", nil, 165000* Desc],
                     ["5Rnd_127x108_Mag", nil, 1500* Desc],
                     ["ffaa_armas_c90", nil, 175000* Desc],
                     ["ffaa_mag_c90", nil, 30000* Desc],
                     ["optic_MRCO", nil, 100* Desc],
                     ["optic_Hamr", nil, 100* Desc],
                     ["RH_ta01nsn", nil, 150* Desc],
                     ["optic_Arco", nil, 100* Desc],
                     ["RH_eotech553", nil, 200* Desc],
                     ["RH_ta31rmr_2D", nil, 200* Desc],
                     ["optic_mas_Arco_blk", nil, 200* Desc],
                     ["optic_mas_DMS", nil, 200* Desc],
                     ["optic_SOS", nil, 200* Desc],
                     ["RH_accupoint", nil, 200* Desc],
                     ["acc_pointer_IR", nil, 50* Desc],
                     ["acc_flashlight", nil, 50* Desc],
                     ["acc_mas_pointer_IR_b", nil, 100* Desc],
                     ["optic_mas_LRPS", nil, 250* Desc],
                     ["RH_accupoint", nil, 200* Desc],
                     ["RH_m110sd", nil, 200* Desc],
                     ["muzzle_snds_H_MG", nil, 500* Desc],
                     ["muzzle_snds_B", nil, 500* Desc],
                     ["RH_qdss_nt4", nil, 200* Desc],
					 ["SmokeShellBlue", "Gas Lacrimogeno", 5000 * Desc]
				 ]
				];
