...
life_action_conoPickup = player addAction["Cancelar Cono",QUICK_fnc_packupcono,"",0,false,false,"",' _cono = nearestObjects[getPos player,["RoadCone_L_F"],8] select 0; !isNil "_cono" && !isNil {(_cono getVariable "item")}'];