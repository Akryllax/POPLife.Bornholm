			...
			case (__GETC__(life_donator) == 3): {
				["Tienda Rebelde+",
				 [
					 ...
					 ["ffaa_optic_g36_holo", nil, 9500],
					 ["RH_ta31rco", nil, 15000]
					 ["RH_m4a1_ris_tg", nil, 150000],
					 ["RH_60Rnd_556x45_Mk262", nil, 1500],
					 ["RH_ta31rmr_tan_2D", nil, 95000],
					 ["RH_fa556_des", nil, 85000],
					 ["ffaa_armas_cetme_c", nil, 250000],
					 ["ffaa_762x51_cedmec", nil, 1500],
					 ["muzzle_snds_B", nil, 7500],
					 ["ffaa_optic_enasa", nil, 8500],
					 ["RH_m110", nil, 450000],
					 ["RH_20Rnd_762x51_M80A1", nil, 5000],
					 ["RH_Saker762_des", nil, 8000],
					 ["RH_ta31rmr_tan", nil, 9000],
					 ["RH_SR25EC", nil, 255000],
					 ["RH_20Rnd_762x51_M80A1", nil, 7500],
					 ["RH_Saker762", nil, 5000],
					 ["RH_accupoint", nil, 5000]
				 ]
				];
			};
