...
class Life_Browse_Group_Diag {
	...
	class controls {
		...
		class Title : Life_RscTitle {
			colorBackground[] = {0, 0, 0, 0};
			idc = -1;
			text = "Dirección del Grupo - Grupos actuales";
			x = 0.1;
			y = 0.2;
			w = 0.6;
			h = (1 / 25);
...
class Life_Create_Group_Diag {
	...
	class controls {
		...
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'>¡La creación de grupos es gratis!</t>";
			x = 0.1;
			y = 0.25;
			w = 0.5; h = (1 / 24);
		};
...
class Life_Group_Prompt
{
	...
	class controls
	{
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'><t size='.8px'>Puedes unirte a un grupo incluso si estas en una banda, despues cuando lo abandones volveras a tu banda si es que la tenias.</t></t>";
			x = 0.310;
			y = 0.2 + (11 / 250);
			w = 0.45; h = 0.12;
		};
