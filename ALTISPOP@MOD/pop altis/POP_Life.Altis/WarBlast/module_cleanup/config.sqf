...
//////////////////////////////
pvpfw_cleanUp_vehicleRadius = 25; // Destroyed vehicles cleanup timer will start if no unit is closer than this
pvpfw_cleanUp_vehicleTimer = 10;

//////////////////
// Clean bodies //
//////////////////
pvpfw_cleanUp_bodyTimer = 1; // Bodies will be removed after the specified amount of seconds
...
pvpfw_cleanUp_ruinRadius = 15; // Destroyed Buildings will be deleted if no entity is in the specified range around them

// Advanced
//#define __pvpfw_cleanUp_cleanExtra //comment out this line if you dont need the objects below to be checked
pvpfw_cleanUp_chemLightTimer = 10; //effectively overrides the max "timeToLive" for the chemlight ammo object which is 900 seconds by default
pvpfw_cleanUp_pipeBombTimer = 1000; //effectively sets a "timeToLive" limit on all explosives, that can be triggered remotely
