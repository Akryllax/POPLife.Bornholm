...
if (life_shop_type == "detodo") exitWith {
   ctrlDelete (_display displayCtrl 2401); // lista tienda
   ctrlDelete (_display displayCtrl 2404); // edit tienda
   ctrlDelete (_display displayCtrl 4073); // lista tienda
};
