...
switch(true) do {
	...
	case (_zone in ["opium_1"]): {_gather = "opium Poppy"; _seeds = "pavot seed"; _val = 3;};
	case (_zone in ["coca_1"]): {_gather = "coca plant"; _seeds = "coca seed"; _val = 3;};
	case (_zone in ["cannabis_1"]): {_gather = "cannabis Plant"; _seeds = "cannabis seed"; _val = 1;};
	case (_zone in ["pumpkin_1"]): {_gather = "pumpkin"; _seeds = "pumpkin seed"; _val = 3;};
	default {""};
};
