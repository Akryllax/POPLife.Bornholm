...
switch (true) do {
	...
	case (_house in ["Land_i_Shed_Ind_F"]): {[10000000,4]};
	case (_house in ["Land_mbg_ger_pub_1","Land_mbg_ger_pub_2"]): {[10000000,4]};
	...
	case (_house in ["Land_A_Villa_EP1"]): {[50000000,6]};
	case (_house in ["Land_Stone_Gate_F"]): {[900000,0]};
	default {[]};
};