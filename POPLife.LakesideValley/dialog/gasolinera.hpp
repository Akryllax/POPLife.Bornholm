class gasolinera
{
	...
	onUnLoad = "uiNamespace setVariable ['gasolinera', nil]; abierto = nil; entrada = nil; ";
	
	class controls {
		class RscPicture_1200: RscPicture
		{
			text = "acj\paa\Surtidor.paa";
			idc = -1;
		...
		class Repostar: RscEdit
		{
			...
			h = 0.044 * safezoneH;
			text = "1";
			onChar = "_nil = ['actualiza'] execVM ""ica\suministros\gasolinera.sqf""";
		};
