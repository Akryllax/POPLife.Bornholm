/*
Wikipedia por Icaruk
["menu"] execVM "ica\jugador\wikipedia.sqf";
*/
...
_respuesta0 = parseText "<t size='0.97' font='PuristaMedium'>
	...
	Tecla Windows derecha --- Rendirse <br/>
...
_respuesta2 = parseText "<t size='0.97' font='PuristaMedium'>
	...
	Agricultura:<br/>
	Deberás ir a la  tienda de semillas y comprar semillas de algodón, girasoles, aceite de oliva, calabazas o trigo, que cultivarás y tendrás que esperar a que maduren para poder recolectarlas y posteriormente ir a los puntos de venta más cercanos para venderlas,  cada semilla  tiene su zona de cultivo esecífica.<br/> <br/>
</t>";
...
if (_param == "menu") exitWith {
	...
	["actualiza"] execVM "ica\jugador\wikipedia.sqf";
