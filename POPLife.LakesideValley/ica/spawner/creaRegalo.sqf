...
if (isNil {_tipo}) exitWith {
	while {true} do {
		sleep (60 * 45);
		["todo", "randompos", 600, true] execVM "ica\spawner\creaRegalo.sqf";
	};
};
...
if ((typeName _posicion) == "ARRAY") then {
	...
	paq = [player, "anuncio", 
		[8, "Aviso", [1,0,0], 2, _str, [1,1,1], 1.6]
...
// [[_caja, ["<t color=""#FFBF00"" size='1' shadow='1'>" +"Buscar componentes electrónicos",'call FNC_Mineria;', "", 7,false,true,"",""]], "ica_meteAccion", true, true] spawn BIS_fnc_MP;

[[_caja, ["<t color=""#FFBF00"" size='1' shadow='1'>" +"Buscar componentes electrónicos",' ["componentes"] execVM "ica\spawner\busca.sqf"; ', "", 7,false,true,"",""]], "ica_meteAccion", true, true] spawn BIS_fnc_MP;
...
[_caja, (60*15)] call ica_borrame;
[_para, (60*15)]; call ica_borrame;
