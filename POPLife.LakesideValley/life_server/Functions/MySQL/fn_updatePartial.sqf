...
switch(_mode) do {
	...
	//Niveles Ica
	case 8: {
		_query = format["UPDATE experiencia SET expMarinero='%1' WHERE playerid='%2'",expMarinero,_uid];
	};
	
	case 9: {
		_query = format["UPDATE experiencia SET expMineria='%1' WHERE playerid='%2'",expMineria,_uid];
	};
	
	case 10: {
		_query = format["UPDATE experiencia SET expQuimica='%1' WHERE playerid='%2'",expQuimica,_uid];
	};
	
	case 11: {
	
		_query = format["UPDATE experiencia SET expConduccion='%1' WHERE playerid='%2'",expConduccion,_uid];
	};
	
	case 12: {
		_query = format["UPDATE experiencia SET expPA='%1' WHERE playerid='%2'",expPA,_uid];
	};
	
	case 13: {

		_query = format["UPDATE experiencia SET expSupervivencia='%1' WHERE playerid='%2'",expSupervivencia,_uid];
	};
	
	case 14: {
		_query = format["UPDATE experiencia SET expFisico='%1' WHERE playerid='%2'",expFisico,_uid];
	};
	
	case 15: {
		_query = format["UPDATE experiencia SET expEconomia='%1' WHERE playerid='%2'",expEconomia,_uid];
	};
	
	case 16: {
		_query = format["UPDATE experiencia SET expMafia='%1' WHERE playerid='%2'",expMafia,_uid];
	};
