...
_query = switch(_side) do {
	case west: {_returnCount = 11; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, cop_licenses, coplevel, cop_gear, experiencia FROM players WHERE playerid='%1'",_uid];};
	case civilian: {_returnCount = 14; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, civ_licenses, arrested, civ_gear, experiencia , civPosition , alive, jailtime, arrestreason FROM players WHERE playerid='%1'",_uid];};
