...
_Admins = ["76561197992389135","76561198003315759","76561198121127640","76561197995693059","76561198022772705","76561197983805726"]; 			//Add your admin UID here
...
if(isDedicated) then {
	...
	if(getplayeruid player in _Admins) exitWith {
		...
		[[format["El Admin %1 Esta en la Partida",name player]],"Notify_Load",false,false] call AH_fnc_MP; 
	};		
