//this addAction ["<t color='#0099FF'>Sentarse</t>","sitdown.sqf","",0,false,false,"",'player distance _target < 2 && !(_target getVariable["occupied",false]) && isNil "life_sitting_chair" && isNil "life_action_standup"'];
...
life_action_standup = _unit addaction ["<t color='#0099FF'>Levantarse</t>","Rosen\items\standup.sqf"];
