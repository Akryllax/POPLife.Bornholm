...
_bio = nearestObject [[5505.09,15058.6,0],"Land_Medevac_HQ_V1_F"];
...
for "_w2" from 1 to 3 do {_bio setVariable[format["bis_disabled_Door_1",_w2],1,true]; _bio animate [format["Door_%1_rot",_w2],0];};
