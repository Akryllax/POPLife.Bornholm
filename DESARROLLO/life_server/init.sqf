...
//Lockup the dome
private["_dome","_rsb","_cupula","_biolab"];
_dome = nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"];
_rsb = nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"];
_cupula = nearestObject [[5489.98,14995.3,0],"Land_Dome_Big_F"];
_biolab = nearestObject [[5505.09,15058.6,18],"Land_Medevac_HQ_V1_F"];
...
for "_i" from 1 to 3 do {_biolab setVariable[format["bis_disabled_Door_%1",_i],1,true]; _biolab animate [format["Door_%1_rot",_i],0];};
_rsb setVariable["bis_disabled_Door_1",1,true];
_rsb allowDamage false;
_dome allowDamage false;
_cupula allowDamage false;
_biolab allowDamage false;
