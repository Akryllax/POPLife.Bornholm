...
_query = switch(_side) do {
	...
	case civilian: {_returnCount = 12; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, civ_licenses, arrested, civ_gear, civPosition, alive, presidente FROM players WHERE playerid='%1'",_uid];};
