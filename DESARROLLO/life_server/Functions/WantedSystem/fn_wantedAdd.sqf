...
switch(_type) do
{
	...
	case "8": {_type = ["8",6500]};
	case "9": {_type = ["9",20000]};
	case "10": {_type = ["10",4500]};
	case "11": {_type = ["11",5000]};
	case "12": {_type = ["12",3000]};
	case "13": {_type = ["13",2000]};
	case "14": {_type = ["14",10000]};
	case "15": {_type = ["15",1000]};
	case "16": {_type = ["16",3500]};
	case "17": {_type = ["17",2000]};
	case "18": {_type = ["18",15000]};
	case "19": {_type = ["19",1500]};
	case "20": {_type = ["20",700]};
	case "21": {_type = ["21",1300]};
	case "22": {_type = ["22",1000]};
	case "23": {_type = ["23",5000]};
	case "24": {_type = ["24",9500]};
	case "25": {_type = ["25",6500]};
	case "26": {_type = ["26",2000]};
	case "27": {_type = ["27",45000]};
	case "28": {_type = ["28",15000]};	
