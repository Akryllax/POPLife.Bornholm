...
if (_data == "economy") exitwith {[[_type,_queryResult],"War_fnc_virt_updateEconomy",_unit,false] spawn life_fnc_MP;};

[[_type,_queryResult],"War_fnc_virt_updateprice",_unit,false] spawn life_fnc_MP;