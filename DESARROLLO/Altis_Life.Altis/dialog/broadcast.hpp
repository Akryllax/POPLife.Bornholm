class life_broadcast_menu {
	...
	class controls {
		...
		class OK_Button: Life_RscButtonMenu
		{
			...
			w = 0.10572 * safezoneW;
			h = 0.0188029 * safezoneH;
			onButtonClick = "['atm','take',300000] call life_fnc_updateCash; [[ctrlText 10402,ctrlText 10404,profileName],'life_fnc_showBroadcast',true,false] spawn BIS_fnc_MP; life_last_broadcast = time; publicVariable ""life_last_broadcast""; closeDialog 0;";
		};
