...
if(_time < 1) then{		
	...
	//si a roabdo pagar al ladron y esta vivo
...
//dar oro
[true,"goldbar",round(1 + random(2))] call life_fnc_handleInv;

//pagar al jugador
[]spawn{sleep 2;hint format["Has robado la joyeria",_this select 0];sleep 3;hint ""};
