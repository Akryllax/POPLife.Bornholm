...
#define STR_TOSS_ROPES "Soltar cuerdas"
#define STR_FAST_ROPE "Tirarse por la cuerda"
#define STR_CUT_ROPES "Cortar cuerdas"
...
zlt_rope_helis = ["O_Heli_Light_02_unarmed_F","O_Heli_Light_02_F","B_Heli_Transport_01_F","B_Heli_Transport_01_camo_F","I_Heli_light_03_unarmed_F","O_Heli_Attack_02_F","O_Heli_Attack_02_black_F","I_Heli_Transport_02_F","B_Heli_Light_01_F"];
zlt_rope_helidata =
[
	[
...
zlt_fnc_fastropeUnit = {
	private ["_unit","_heli","_ropes","_rope","_zmax","_zdelta","_zc","_position"];
	_unit = _this;
	_heli = vehicle _unit;
	...
	_position = [getpos _unit select 0, getpos _unit select 1, 0 max ((getpos _unit select 2) - 3)];
	[[_unit, _position],"TON_fnc_Amarok_SetPos",false,false] spawn life_fnc_MP;
