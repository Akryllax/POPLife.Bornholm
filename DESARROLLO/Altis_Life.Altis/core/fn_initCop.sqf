...
switch (__GETC__(life_coplevel)) do
			{
				...
				case 5: { life_paycheck = ((6000) + (_donatorlevel)); }; //GC
				case 6: { life_paycheck = ((7000) + (_donatorlevel)); }; //GC 2
				case 7: { life_paycheck = ((8000) + (_donatorlevel)); }; //GEO
				case 8: { life_paycheck = ((9000) + (_donatorlevel)); }; //Capitan
